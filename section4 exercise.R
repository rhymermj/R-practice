...
#Free Throws
KobeBryant_FTA <- c(696,667,623,483,439,483,381,525,18,196)
JoeJohnson_FTA <- c(261,235,316,299,220,195,158,132,159,141)
LeBronJames_FTA <- c(601,489,549,594,593,503,387,403,439,375)
CarmeloAnthony_FTA <- c(573,459,464,371,508,507,295,425,459,189)
DwightHoward_FTA <- c(356,390,529,504,483,546,281,355,349,143)
ChrisBosh_FTA <- c(474,463,472,504,470,384,229,241,223,179)
ChrisPaul_FTA <- c(394,292,332,455,161,337,260,286,295,289)
KevinDurant_FTA <- c(209,209,391,452,756,594,431,679,703,146)
DerrickRose_FTA <- c(146,146,146,197,259,476,194,0,27,152)
DwayneWade_FTA <- c(629,432,354,590,534,494,235,308,189,284)

#Matrix for Free Throws
#
#Bind the given vectors to form the matrix
FreeThrows <- rbind(KobeBryant_FTA, JoeJohnson_FTA, LeBronJames_FTA, CarmeloAnthony_FTA, DwightHoward_FTA, ChrisBosh_FTA, ChrisPaul_FTA, KevinDurant_FTA, DerrickRose_FTA, DwayneWade_FTA)
...
myplot <- function(data,rows=1:10){
  matplot(t(data[rows,,drop=F]), type="b", pch=15:18, col=c(1:4,6), main="Basketball Players Analysis")
  legend("bottomleft", inset=0.01, legend=Players[rows], col=c(1:4,6), pch=15:18, cex=0.5, horiz=F)
}
...
#Analysis - Notice how Chris Paul gets few attempts per game
